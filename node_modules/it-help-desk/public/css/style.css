...
.card .card-header .card-comment-title {
    padding: 1.2em;
    float: left; }
.card .card-header .card-comment-title .title {
    font-family: 'Roboto Condensed', sans-serif;
    font-size: 1.5em;
    text-decoration: none; }
...
.pricing-table1 .pt-header {
    float: left;
    text-align: left;
    /*padding: 1em; */}
.pricing-table1 .pt-header .plan-pricing .pricing {
    font-size: 2.5em; }
.pricing-table1 .pt-header .plan-pricing .pricing-type {
    opacity: 0.9; }

.pricing-table1 .pt-body {
    /*padding: 1em;*/
    text-align: left; }
.pricing-table1 .pt-body .plan-detail {
    padding: 0;
    margin: 0;
    list-style: none; }

.pricing-table1 .pt-footer {
    padding: 0.75em;
    text-align: right; }
...
.message-list > li > .message-block-comment {
    padding-left: 5px;
    padding-right: 5px;
    min-height: 60px; }

.message-list > li > .message-block-comment .username {
    font-size: 12px;
    font-weight: bold; }
.message-list > li > .message-block-comment .usernameby {
    padding-right: 5px;
    font-size: 10px;
    color: #AAA; }
.message-list > li > .message-block-comment .message-datetime {
    padding-left: 100px;
    font-size: 10px;
    color: #AAA; }

.message-list > li > .message-block-comment .message {
    font-size: 12px; }
