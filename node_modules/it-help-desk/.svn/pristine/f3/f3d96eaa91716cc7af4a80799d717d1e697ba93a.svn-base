...
<div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <table class="table" datatable="ng" width="100%" dt-options="dtOptions">
                        ...
                        <tbody>
                            <tr ng-repeat="x in data=(NewTickets)">
                                ...
                                <td>
                                <time-ago from-time='{{ x.reportedDate}}'></time-ago>
                                 </td>                                
                            </tr>
                        </tbody>
                    </table> 
                ...
                <div class="panel fresh-color panel-primary">
                    <div class="panel-heading">Work in Progress Ticket</div>
                    <table class="table" datatable="ng" width="100%" dt-options="dtOptions" >
                        <thead>
                            <tr>
                                <th>Ticket ID</th>
            ...
            <div class="panel fresh-color panel-success">
                    <div class="panel-heading">My Assigned Tickets</div>
                    <table class="table" datatable="ng" width="100%" dt-options="dtOptions">
                        <thead>
                            <tr>
                                <th>Ticket ID</th>
                ...
                <div class="panel fresh-color panel-primary">
                    <!-- Default panel contents -->
                    <div class="panel-heading">TAT Exceeded Tickets</div>
                     <table class="table" datatable="ng" width="100%" dt-options="dtOptions">
                        <thead>
                            <tr>
                                <th>Ticket ID</th>
